      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
                l10n.termsServiceDescTitle, l10n.termsServiceDescBody),
            ...
            _buildSection(l10n.termsHealthDisclaimerTitle,
                l10n.termsHealthDisclaimerBody),
            _buildSection(
                l10n.termsAcceptableUseTitle, l10n.termsAcceptableUseBody),
            _buildSection(l10n.termsIpTitle, l10n.termsIpBody),
            _buildSection(
                l10n.termsUserContentTitle, l10n.termsUserContentBody),
            _buildSection(l10n.termsLiabilityTitle, l10n.termsLiabilityBody),
            _buildSection(
                l10n.termsIndemnificationTitle, l10n.termsIndemnificationBody),
            _buildSection(
                l10n.termsTerminationTitle, l10n.termsTerminationBody),
            _buildSection(l10n.termsChangesTitle, l10n.termsChangesBody),
            _buildSection(
                l10n.termsGoverningLawTitle, l10n.termsGoverningLawBody),
            _buildSection(l10n.termsDisputeTitle, l10n.termsDisputeBody),
            _buildSection(l10n.termsContactTitle, l10n.termsContactBody),
            _buildSection(
                l10n.termsSeverabilityTitle, l10n.termsSeverabilityBody),
