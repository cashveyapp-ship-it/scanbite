// home_screen.dart
// âœ… Average Rating pill is now clickable
// âœ… Tapping â­ rating opens RateAppScreen
...
import 'rate_app_screen.dart'; // âœ… ADD THIS IMPORT
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Unlimited scans â€¢ ${freeScansRemaining < 0 ? 0 : freeScansRemaining} free scans left',
                                style: const TextStyle(
                                  fontSize: 13,
                                  color: Colors.white,
                                ),
              ...
              Center(
                child: _PulsingWrapper(
                  child: GestureDetector(
                    onTap: () async {
                      // âœ… YOUR EXISTING SCAN CODE â€” DO NOT CHANGE
...
/// âœ… Average rating pill that reads from Firestore `app_ratings`
/// âœ… Tapping it opens RateAppScreen
...
class _PulsingWrapperState extends State<_PulsingWrapper>
  ...
  void initState() {
    ...
    )..repeat(reverse: true); // ðŸ”¥ LOOP FOREVER
